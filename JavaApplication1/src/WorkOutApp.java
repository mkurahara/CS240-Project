 ...
 */
    ...
    private void initBuild(){
        ...
        String inputFile = "src/workoutfile.abc";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
       SurveyGuiUI g= new SurveyGuiUI(new Survey(Username.user, rout), rout.getRoutine());
       g.setVisible(true);
    ...
    private void initComponents(){
        ...
        int userDifficulty = Username.liftingExp; //userInfo.getDifficulty(); //Need to implement
        int focusArea = Username.focusArea; //userInfo.getFocus();
