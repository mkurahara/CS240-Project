...
public class SurveyGuiUI extends javax.swing.JFrame {
     ...
     * @param survey
     */
    public SurveyGuiUI(Survey survey, ArrayList<Exercise> routList) {
    ...
    private void initComponents() {
        ...
        jButton1_submit.addActionListener(this::jButton1_submitActionPerformed);

        ex1Description.setText(routineList.get(0).getName() + ": " + routineList.get(0).getDescription());
        ...
        ex1Difficulty.addItemListener((ItemEvent e) -> {
        ...
        ex1Description1.setText(routineList.get(1).getName() + ": " + routineList.get(1).getDescription());
        ...
        if(routineList.size() < 3){
            ex1Description2.setText("Come up with your own exercise. What do you like to do?");
        }else{
            ex1Description2.setText(routineList.get(2).getName() + ": " + routineList.get(2).getDescription());
        }
    ...
    private void jButton1_submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1_submitActionPerformed
        ...
        switch (comfValue) {
            case "comfortable":
                survey.setTotalComfort(survey.getTotalComfort() + 1);
                break;
        //survey.setExp(); to do later
            case "semi-comfortable":
                survey.setTotalComfort(survey.getTotalComfort() + 2);
                break;
            case "uncomfortable":
                survey.setTotalComfort(survey.getTotalComfort() + 3);
                break;
            default:
                break;
        }
        ...
        try{Integer.parseInt(jTextField1.getText());
               ...
               MongoCollection<Document> users= dB.getCollection("users");
                int bench= Integer.parseInt(jTextField1.getText());     
                Username.setBench(Integer.parseInt(jTextField1.getText()));
                 survey.setBnchMx(Integer.parseInt(jTextField1.getText()));
                wt1Done = true;
                Bson bson= Filters.all("username", Username.user);
                int squat= Integer.parseInt(jTextField2.getText());
                Username.setSquat(Integer.parseInt(jTextField2.getText()));
                 survey.setSqtMx(Integer.parseInt(jTextField2.getText()));
                wt2Done = true;
                int clean= Integer.parseInt(jTextField3.getText());
                survey.setClnMx(Integer.parseInt(jTextField3.getText()));
                wt3Done = true;
                Document doc= new Document("username", Username.user).append("password",Username.password).append("liftingExp",Username.liftingExp).append("liftingGoal",Username.focusArea).append("currentSquatMax",squat).append("currentCleanMax",clean).append("currentBenchMax",bench).append("initialSquatMax",Username.initSquat).append("initialCleanMax",Username.initHang).append("initialBenchMax", Username.initBench);
                users.findOneAndReplace(bson,doc);
        } catch(NumberFormatException e){JOptionPane.showMessageDialog(this, "Weights must be whole integer numbers. Please refile survey.");}
    ...
    ArrayList<Exercise> routine = new ArrayList<>();
